...
From the above results, we can see that the average number of probes for a miss is proportional to 1/(1-α)^2.

This can be verified by the following calculations:

+------+-------+-----------------------+-----------------------+
|  M   |   α   |  Avg # probes for a miss| 1/2(1/(1-α)^2)        |
+------+-------+-----------------------+-----------------------+
|  2   |  1/2  |          2.5          |         2.5          |
| 1.5  |  2/3  |          5.1          |        5.0          |
| 1.25 |  4/5  |          12.5         |       13.0          |
